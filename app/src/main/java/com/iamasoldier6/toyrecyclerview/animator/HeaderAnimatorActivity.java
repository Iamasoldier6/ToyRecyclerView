 ...
 * @date: 2017/07/26
 */
public class HeaderAnimatorActivity extends BaseActivity {
    ...
    public void setupToolbar() {
        getSupportActionBar().setTitle(getResources().getString(R.string.toy_recycler_view_header_animator));
    ...
    private void initView() {
        ...
        mAnimatorAdapter = AnimatorAdapter.createAnimatorAdapter(this, itemList, AnimatorAdapter.HEADER);
