...
public class HorizontalActivity extends BaseActivity {
    ...
    public void setupToolbar() {
        getSupportActionBar().setTitle(getString(R.string.toy_recycler_view_horizontal));
    ...
    private void initView() {
        ...
        mRvCommon.setAdapter(BackgroundAdapter.createBackgroundAdapter(this, IconHelper.VARIETY_ICONS, BackgroundAdapter.BLUE));
    }
