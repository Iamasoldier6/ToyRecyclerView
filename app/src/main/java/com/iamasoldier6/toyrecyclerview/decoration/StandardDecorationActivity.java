 ...
 * @date: 2017/07/26
 */
public class StandardDecorationActivity extends BaseActivity {
    ...
    public void setupToolbar() {
        getSupportActionBar().setTitle(getString(R.string.toy_recycler_view_decoration_standard));
    ...
    private void initView() {
        ...
        mRvCommon.addItemDecoration(new StandardDecoration(this));
